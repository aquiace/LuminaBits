...
#define LED_PIN   5  //Pin for the pixel strand. Can be analog or digital.
#define LED_TOTAL 35  //Change this to the number of LEDs in your strand.
#define LED_HALF  LED_TOTAL/2
#define VISUALS   6   //Change this accordingly if you add/remove a visual in the switch-case in Visualize()

#define AUDIO_PIN 17  //Pin for the envelope of the sound detector
#define KNOB_PIN  1  //Pin for the trimpot 10K
#define BUTTON_1  12   //Button 1 cycles color palettes
#define BUTTON_2  13   //Button 2 cycles visualization modes
